...
public class CustomizedResponseEntityExceptionHandle extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ValidPhoneNumbersNotFound.class)
    public  final ResponseEntity<Object> handleValidPhoneNumbersNotFound(ValidPhoneNumbersNotFound ex, WebRequest request) {
        ExceptionResponse exceptionResponse =
                new ExceptionResponse(new Date(), ex.getMessage(),
                        request.getDescription(false));
